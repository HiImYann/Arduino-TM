...
void setup() // Built in initialization block
{
 ...
 servoRight.attach(12); // Attach left signal to P13
...
void loop() // Main loop auto-repeats
{
 ...
 servoRight.writeMicroseconds(pulseWidth); // Pin13 servo speed = pulse
 delay(6000); // ..for 6 seconds
 servoRight.writeMicroseconds(1500); // Pin 13 servo speed = stop
